...
public class GameFrame extends JFrame 
{
	...
	{	//These are used to adjust the game frame inward from the corner of the monitor.
        ...
        System.out.println("x screen indent: "+Integer.toString(screenChangeXBy));
        System.out.println("y screen indent: "+Integer.toString(screenChangeYBy));
	 ...
	 */
	public void internalUpdateGraphicsInterpolated(int fps)
	{
