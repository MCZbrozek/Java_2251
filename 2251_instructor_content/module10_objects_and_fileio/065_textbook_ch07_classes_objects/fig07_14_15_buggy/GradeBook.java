...
public class GradeBook
{
	...
	public void processGrades()
	{
		...
		// call method getAverage to calculate the 
		// average grade		
		...
		// call outputBarChart to print grade 
		// distribution chart
		outputBarChart();
	} 
	...
	public int getMinimum()
	{
		...
		{
			// if grade lower than lowGrade, 
			// assign it to lowGrade
			if (grade > lowGrade)
			{
	...
	public int getMaximum()
	{
		...
		for (int grade : grades)
		{
			// if grade greater than highGrade, 
