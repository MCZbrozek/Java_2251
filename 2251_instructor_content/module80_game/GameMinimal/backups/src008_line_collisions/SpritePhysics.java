...
public abstract class SpritePhysics extends Sprite
{
	...
	/** This may only be getting used to have gravity affect non-ballistic
	 * objects. */
	...
	/** The takeDamage method does nothing but should be over-ridden
	 * by any sprites that want to implement damage taking. */
	public void takeDamage(int damage, Sprite responsible_sprite)
	{
		System.out.println("WARNING: Sprite.takeDamage called. This should be overridden.");
		System.exit(0);
	}
	...
	/** Get a deep copy of this sprite. If this is not overridden
	 * then it throws a error and exits. */
