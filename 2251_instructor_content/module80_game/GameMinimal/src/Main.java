...
public class Main
{
	...
	public static final String[] broad_profiler_labels = {"Drawing    ",
			"Computing", "Yielding    "};
	...
	public Main(Board b, boolean fullscreen)
	{
	...
	public Main(Board b, int width, int height)
	{
	 ...
	 * http://stackoverflow.com/questions/4097217/
the-java-concurrent-modification-exception-debacle-of-2010
	 * http://stackoverflow.com/questions/16620005/
concurrent-modification-exception-cause-by-painting
	 * http://stackoverflow.com/questions/17588831/
why-is-paintcomponent-continuously-and-asynchronously-being-called-without-exp
	 */
	public void gameLoop() 
	{
		/* GAME_HERTZ is the number of updates to perform per second.
		This needs to equal the number of frames
		per second since I am not using interpolation. */
		final double GAME_HERTZ = 60.0;
		//Calculate how many nanoseconds each frame should take for our
		//target game hertz.
		...
		while (running)
		{
			...
			if (!paused)
			{
				...
				//If you were doing some sort of game that needed to keep
				...
				//Old rendering was done like this:
				...
				{
					//System.out.println("Main: NEW SECOND " + thisSecond +
					// " " + frame_count);
					fps = frame_count;
					frame_count = 0;
