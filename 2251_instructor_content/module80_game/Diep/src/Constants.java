...
public class Constants
{
	...
	static int suicide_brick_count = 10;

	static final double suicide_brick_speed = 230;

	//Whether or not bricks are invincible by default
	static boolean brick_vulnerability = true;
	...
	static double default_friction = -1.1;
	...
	static final int[] xp_per_level = {4, 10, 12, 16, 20, 24, 30, 36, 42, 50, 58, 66, 74, 82, 90, 100, 110, 120, 130, 130, 130, 140, 140, 140, 140, 150, 150, 150, 150, 200, 200, 200, 250, 250, 250, 250, 250, 250, 250, 250, 250};
	...
	static final int attribute_level_limit = 9;

	static final double[] speed_levels = {180, 210, 240, 270, 300, 330, 360, 390, 420, 450};
	static int[] bullet_damage_levels = {1, 2, 3, 4, 5, 6, 8, 10, 12, 14};
	static double[] bullet_speed_levels = {260, 300, 340, 380, 420, 460, 500, 540, 580, 620};
	static final double[] refire_rate_levels = {0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1, 0.05};
	static final double[] bullet_longevity_levels = {3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8};
	static final int[] health_levels = {50, 75, 100, 125, 150, 175, 200, 225, 250, 275};
	static final double[] regen_levels = {4, 3.5, 3, 2.5, 2, 1.5, 1, 0.5, 0.25, 0.15};
	static final int[] collision_damage_levels = {3, 4, 5, 6, 7, 9, 11, 13, 16, 20};
	static final int[] bullet_health_levels = {1, 2, 4, 6, 8, 10, 12, 14, 18, 24};
	...
	static final int SHAPE_LASER = 19;
	static final int SHAPE_RICOCHET = 20;
	static final int SHAPE_RICOCHET_SHOT = 21;
	...
	static final int POW_EXPLODING_BULLETS = 7;
	static final int POW_BLACKHOLE = 8;
	static final int POW_BIG_BULLETS = 9;
	static final int POW_BRICKSTRAVAGANZA = 10;
	static final int POW_TELEPORT = 11;
	static final int POW_MIMIC = 12;
	static final int NUM_POWERUPS = 13;

	static final String[] POWERUP_NAMES = {
		"Triple-Shot",
		"Invincibility",
		"Spread-Shot",
		"Speed-Up",
	...
	static void loadExperienceBricks(Board b,
			int brick_count,
	...
	static void loadExperienceBricks(
		double x, double y, Board b, int brick_count,
		int health, double radius,
		int reward, Color c, int shape,
		boolean suicidal,
		int body_damage,
	...
	static final ShipUpgradeStruct[] ship_upgrade_list = {
			...
			new ShipUpgradeStruct(ship_upgrade_level_limit + ship_upgrade_step, "Upgrade to gravity", SHAPE_GRAVITY, SHAPE_RAMMER),
			...
			new ShipUpgradeStruct(ship_upgrade_level_limit + 2 * ship_upgrade_step, "Upgrade to exploder", SHAPE_EXPLODER, SHAPE_GRAVITY),
			...
			new ShipUpgradeStruct(ship_upgrade_level_limit + 3 * ship_upgrade_step, "Upgrade to laser", SHAPE_LASER, SHAPE_SNIPER),
			new ShipUpgradeStruct(ship_upgrade_level_limit + ship_upgrade_step, "Upgrade to ricochet ram", SHAPE_RICOCHET, SHAPE_RAMMER),
			new ShipUpgradeStruct(ship_upgrade_level_limit + ship_upgrade_step, "Upgrade to ricochet shot", SHAPE_RICOCHET_SHOT, SHAPE_MACHINE_GUN)
		};
