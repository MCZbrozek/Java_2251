...
public class NPC_FishTheBishBoi extends NPC_Personality
{
    public NPC_FishTheBishBoi(Board b)
    {
        super(b);
        ...
        String[] temp_upgrade_sequence = {"Bullet Damage",
                ...
                "Refire Rate", "Refire Rate", "Bullet Damage", "Bullet Speed",
                "Bullet Speed", "Bullet Damage", "Bullet Damage", "Bullet Damage",
                "Refire Rate","Refire Rate","Refire Rate","Refire Rate","Refire Rate",
                "Bullet Speed", "Bullet Speed", "Bullet Speed", "Bullet Speed","Speed",
                "Speed","Speed","Speed","Health","Health","Health","Health","Health Regen","Health Regen","Health Regen"};
