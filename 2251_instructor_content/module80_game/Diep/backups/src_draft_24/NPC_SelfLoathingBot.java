...
public class NPC_SelfLoathingBot extends NPC_Personality
{
    ...
    public NPC_SelfLoathingBot(Board b)
    {
        ...
        String[] temp_upgrade_sequence={"Bullet Damage","Penetration", "Bullet Damage", "Bullet Damage", "Bullet Damage", "Bullet Damage", "Bullet Damage", "Bullet Damage", "Bullet Damage",  "Refire Rate", "Refire Rate", "Refire Rate", "Refire Rate", "Refire Rate", "Refire Rate", "Refire Rate", "Refire Rate", "Bullet Speed", "Bullet Speed", "Bullet Speed", "Bullet Speed", "Bullet Speed", "Bullet Speed", "Bullet Speed", "Bullet Speed", "Penetration", "Penetration", "Penetration", "Penetration", "Penetration", "Penetration", "Penetration"};
