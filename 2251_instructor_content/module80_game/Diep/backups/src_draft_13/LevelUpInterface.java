...
class LevelUpInterface
{
    ...
    private ShipUpgrade[] ship_upgrades = new ShipUpgrade[5];
    ...
    LevelUpInterface(Ship s, Board b)
    {
        ...
        int[] precursor_list = {Constants.SHAPE_CIRCLE,Constants.SHAPE_CIRCLE,
                Constants.SHAPE_CIRCLE,Constants.SHAPE_CIRCLE,
