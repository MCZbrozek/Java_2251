...
public class NPC_Random extends NPC_Personality
{
    public NPC_Random(Board b)
    {
        super(b);
        ...
        */
        ...
        else if(rand_choice==7)
        {
            this.ship_upgrade_sequence = new int[2];
            this.ship_upgrade_sequence[0] = Constants.SHAPE_MACHINE_GUN;
            this.ship_upgrade_sequence[1] = Constants.SHAPE_RICOCHET_SHOT;
        }
