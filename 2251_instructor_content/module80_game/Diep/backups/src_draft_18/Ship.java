...
public class Ship extends SpriteTopDown
{
    ...
    * the invicibility powerup. */
    ...
    boolean cloaked(){ return (this.shape==Constants.SHAPE_MIMIC || this.shape==Constants.SHAPE_CLOAK) && cloak_cooldown<0; }
