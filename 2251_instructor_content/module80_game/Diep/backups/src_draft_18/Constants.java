...
class Constants
{
    ...
    static final int[] collision_damage_levels = {3, 4, 5, 6, 7, 9, 11, 13};//{1, 2, 3, 4, 5, 6, 7, 8};
    ...
    static final int SHAPE_CLOAK = 14;
    ...
    static final double cloak_speed_limit = 50.0;

    //Level at which ship upgrades become available.
    //Later on this should be different for different ships.
    static final int ship_upgrade_level_limit = 7;
    static final int ship_upgrade_step = 4;
    ...
    static final ShipUpgradeStruct[] ship_upgrade_list =
            {
                    new ShipUpgradeStruct(ship_upgrade_level_limit, "Upgrade to rammer ship", SHAPE_RAMMER, SHAPE_CIRCLE),
                    new ShipUpgradeStruct(ship_upgrade_level_limit, "Upgrade to flanker ship", SHAPE_FLANKER, SHAPE_CIRCLE),
                    new ShipUpgradeStruct(ship_upgrade_level_limit, "Upgrade to twin-shot ship", SHAPE_TWIN, SHAPE_CIRCLE),
                    new ShipUpgradeStruct(ship_upgrade_level_limit, "Upgrade to machine gun ship", SHAPE_MACHINE_GUN, SHAPE_CIRCLE),
                    new ShipUpgradeStruct(ship_upgrade_level_limit + ship_upgrade_step, "Upgrade to exploder ship", SHAPE_EXPLODER, SHAPE_RAMMER),
                    new ShipUpgradeStruct(ship_upgrade_level_limit + ship_upgrade_step, "Upgrade to mimic ship", SHAPE_MIMIC, SHAPE_RAMMER),
                    new ShipUpgradeStruct(ship_upgrade_level_limit + ship_upgrade_step, "Upgrade to cross ship", SHAPE_CROSS, SHAPE_FLANKER),
                    new ShipUpgradeStruct(ship_upgrade_level_limit + ship_upgrade_step, "Upgrade to sniper ship", SHAPE_SNIPER, SHAPE_TWIN),
                    new ShipUpgradeStruct(ship_upgrade_level_limit + 3 * ship_upgrade_step, "Upgrade to carrier ship", SHAPE_CARRIER, SHAPE_MACHINE_GUN),
                    new ShipUpgradeStruct(ship_upgrade_level_limit + 2 * ship_upgrade_step, "Upgrade to gravity ship", SHAPE_GRAVITY, SHAPE_EXPLODER),
                    new ShipUpgradeStruct(ship_upgrade_level_limit + 2 * ship_upgrade_step, "Upgrade to cloaked ship", SHAPE_CLOAK, SHAPE_MIMIC),
                    new ShipUpgradeStruct(ship_upgrade_level_limit + 2 * ship_upgrade_step, "Upgrade to all-direction ship", SHAPE_All_DIRECTIONS, SHAPE_CROSS),
                    new ShipUpgradeStruct(ship_upgrade_level_limit + 2 * ship_upgrade_step, "Upgrade to seeker missile ship", SHAPE_SEEKER, SHAPE_SNIPER),
                    new ShipUpgradeStruct(ship_upgrade_level_limit + 2 * ship_upgrade_step, "Upgrade to cannon ship", SHAPE_CANNON, SHAPE_SNIPER)
            };
