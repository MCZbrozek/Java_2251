...
class Constants
{
    ...
    static final int SHAPE_MACHINE_GUN = 4;
    static final int SHAPE_FLANKER = 5;
    static final int SHAPE_SNIPER = 6;
    static final int SHAPE_RAMMER = 7;
    static final int SHAPE_TWIN = 8;
    static final int SHAPE_CROSS = 9;
    static final int SHAPE_All_DIRECTIONS = 10;
    static final int SHAPE_CLOAK = 11;
    static final int SHAPE_EXPLODER = 12;
    static final int SHAPE_GRAVITY = 13;
    static final int SHAPE_CANNON = 14;
    static final int SHAPE_SEEKER = 15;
    static final int SHAPE_MIMIC = 16;
    static final int SHAPE_CARRIER = 17;
