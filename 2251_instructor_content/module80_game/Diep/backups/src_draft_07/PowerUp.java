...
class PowerUp extends SpriteTopDown
{
    ...
    private int powerup_id = Constants.POW_SHOVE_OUT; //(int)(Math.random()*Constants.NUM_POWERUPS);
    ...
    public void takeDamage(int damage, Sprite damage_dealer)
    {
        ...
        if(this.getHealth()<=0)
        {
            ...
            powerup_id = Constants.POW_SHOVE_OUT; //(int)(Math.random()*Constants.NUM_POWERUPS);
            this.setHealthMax();
