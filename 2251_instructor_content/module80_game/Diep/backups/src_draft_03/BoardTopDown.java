...
public class BoardTopDown extends Board
{
	...
	BoardTopDown()
	{
		...
		System.out.println("Total possible levelups is currently "+Constants.xp_per_level.length);
		...
		for (int i = 0; i < Constants.low_exp_brick_count; i++)
		{
			this.addSprite(
					new ExperienceBrick(
							Constants.getRandomX(),
		...
		for (int i = 0; i < Constants.med_exp_brick_count; i++)
		{
			this.addSprite(
					new ExperienceBrick(
							Constants.getRandomX(),
		...
		for (int i = 0; i < Constants.high_exp_brick_count; i++)
		{
			this.addSprite(
					new ExperienceBrick(
							Constants.getRandomX(),
