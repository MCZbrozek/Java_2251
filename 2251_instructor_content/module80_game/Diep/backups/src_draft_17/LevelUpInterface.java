...
class LevelUpInterface
{
    ...
    private ShipUpgrade[] ship_upgrades = new ShipUpgrade[14];
    ...
    LevelUpInterface(Ship s, Board b)
    {
        ...
        String[] text_list = {"Upgrade to machine gun ship",
                ...
                "Upgrade to gravity ship",
                "Upgrade to cannon ship",
                "Upgrade to seeker missile ship",
                "Upgrade to mimic ship",
                "Upgrade to carrier ship"};
        ...
        int[] level_list = {Constants.ship_upgrade_level_limit,
                ...
                Constants.ship_upgrade_level_limit+Constants.ship_upgrade_step,//Sniper is upgrade from twin shot
                Constants.ship_upgrade_level_limit,
                Constants.ship_upgrade_level_limit,
                Constants.ship_upgrade_level_limit+Constants.ship_upgrade_step,//Cross ship upgrade from flanker
                Constants.ship_upgrade_level_limit+2*Constants.ship_upgrade_step,//All direction ship upgrades from cross
                Constants.ship_upgrade_level_limit+2*Constants.ship_upgrade_step,//Cloaked ship is upgrade of mimic
                Constants.ship_upgrade_level_limit+Constants.ship_upgrade_step,//Exploder ship is upgrade of rammer
                Constants.ship_upgrade_level_limit+2*Constants.ship_upgrade_step,//Gravity ship is upgrade of exploder
                Constants.ship_upgrade_level_limit+2*Constants.ship_upgrade_step,//Cannon ship is upgrade of sniper
                Constants.ship_upgrade_level_limit+2*Constants.ship_upgrade_step,//Seeker ship is upgrade of sniper
                Constants.ship_upgrade_level_limit+Constants.ship_upgrade_step,//Mimic ship is upgrade of rammer
                Constants.ship_upgrade_level_limit+3*Constants.ship_upgrade_step};//Carrier ship is upgrade of machine gun
        ...
        int[] precursor_list = {Constants.SHAPE_CIRCLE,
                ...
                Constants.SHAPE_TWIN,//Sniper is upgrade from twin shot
                Constants.SHAPE_CIRCLE,
                Constants.SHAPE_CIRCLE,
                Constants.SHAPE_FLANKER,//Cross ship upgrade from flanker
                Constants.SHAPE_CROSS,//All direction ship upgrades from cross
                Constants.SHAPE_MIMIC,//Cloaked ship is upgrade of mimic
                Constants.SHAPE_RAMMER,//Exploder ship is upgrade of rammer
                Constants.SHAPE_EXPLODER,//Gravity ship is upgrade of exploder
                Constants.SHAPE_SNIPER,//Cannon ship is upgrade of sniper
                Constants.SHAPE_SNIPER,//Seeker ship is upgrade of sniper
                Constants.SHAPE_RAMMER,//Mimic ship is upgrade of rammer
                Constants.SHAPE_MACHINE_GUN};//Carrier is upgrade of machine gun
    ...
    void levelUp(double x, double y)
    {
        ...
        for (ShipUpgrade ship_upgrade : ship_upgrades)
        {
            ...
            {
                focused.setShape(ship_upgrade.ship_shape);
