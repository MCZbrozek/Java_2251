            ...
            {   //Draw sprite
                ...
                if (!no_direction_draw)
                {
                    ...
                    if(shape == Constants.SHAPE_MACHINE_GUN)
                    {
                        ...
                        int[] x_points = {
                                (int) (draw_x + radius + 30 * Math.cos(this.getAngle()) + 10 * Math.cos(this.getAngle() + Math.PI / 2)),
                                (int) (draw_x + radius + 30 * Math.cos(this.getAngle()) + 10 * Math.cos(this.getAngle() - Math.PI / 2)),
                                (int) (draw_x + radius + 50 * Math.cos(this.getAngle()) + 15 * Math.cos(this.getAngle() - Math.PI / 2)),
                                (int) (draw_x + radius + 50 * Math.cos(this.getAngle()) + 15 * Math.cos(this.getAngle() + Math.PI / 2))};
                        int[] y_points = {
                                (int) (draw_y + radius + 30 * Math.sin(this.getAngle()) + 10 * Math.sin(this.getAngle() + Math.PI / 2)),
                                (int) (draw_y + radius + 30 * Math.sin(this.getAngle()) + 10 * Math.sin(this.getAngle() - Math.PI / 2)),
                                (int) (draw_y + radius + 50 * Math.sin(this.getAngle()) + 15 * Math.sin(this.getAngle() - Math.PI / 2)),
                                (int) (draw_y + radius + 50 * Math.sin(this.getAngle()) + 15 * Math.sin(this.getAngle() + Math.PI / 2))};
