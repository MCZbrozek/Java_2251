...
class LevelUpInterface
{
    ...
    private ShipUpgrade[] ship_upgrades = new ShipUpgrade[10];
    ...
    LevelUpInterface(Ship s, Board b)
    {
        ...
        int[] level_list = {Constants.ship_upgrade_level_limit,
                ...
                Constants.ship_upgrade_level_limit+0};//Gravity ship is upgrade of rammer
        ...
        int[] precursor_list = {Constants.SHAPE_CIRCLE,
                ...
                Constants.SHAPE_RAMMER};//Gravity ship is upgrade of rammer
