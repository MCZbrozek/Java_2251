...
class Constants
{
    ...
    static final int low_exp_brick_count = 100;
    static final int med_exp_brick_count = 20;
    static final int high_exp_brick_count = 5;

    //Recoil from shooting
    static final double recoil = 1.0;
    //Friction applied to all SpriteTopDown objects
    static final double friction = -1.10; //Usually out of 100, making this over 100 means it takes less than 1 second to lose all momentum.
    ...
    static final double shove_out_impulse = 10.0;
    ...
    static final int[] xp_per_level = {4, 10, 12, 16, 20, 24, 30, 36, 42, 50, 58, 66, 74, 82, 90, 100, 110, 120, 130, 140, 150};
    ...
    static final double[] speed_levels = {200, 230, 260, 290, 320, 350, 380, 410};
    static final int[] bullet_damage_levels = {1, 2, 3, 4, 5, 6, 7, 8};
    static final double[] bullet_speed_levels = {300, 340, 380, 420, 460, 500, 540, 580};
    static final double[] refire_rate_levels = {0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1};
    ...
    static final double[] regen_levels = {8, 7, 6, 5, 4, 3, 2, 1};
