...
public class Player extends Ship
{
	...
	public void update(double elapsed_seconds)
	{
		...
		if(key_setter.ascii_input[8])//backspace key to reset ship back to original shape
		{
	...
	public MouseSprite getMouseXY(){ return new MouseSprite(this, this.key_setter); }
}