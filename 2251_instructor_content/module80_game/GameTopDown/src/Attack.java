...
public class Attack
{
    ...
    //Whether or not the shot removes itself upon collision
    private boolean penetrating = false;
    //Whether or not the shot moves the player to its center as it travels
    private boolean player_follow = false;
    ...
    public double getPercentCooldown(){return Math.max(0,1-(cooldown/cooldown_duration));}
